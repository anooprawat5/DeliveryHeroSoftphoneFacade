...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://dist.acrobits.cz/deliveryhero-softphonefacade/SoftphoneFacadeLib.xcframework-1817275.zip",
            checksum: "617d9349e84dfbb2192929d3ab02adb769602736a6dd8c5237d8cbd9720f56b8"
        )
    ]
)
