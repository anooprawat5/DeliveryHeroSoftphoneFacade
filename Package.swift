...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://dist.acrobits.cz/deliveryhero-softphonefacade/SoftphoneFacadeLib.xcframework-1814807.zip",
            checksum: "3b06582f61cc50cce9552acfa9d927de097829ddaefba9fa32f86df455afdb11"
        )
    ]
)
