...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/acrobits/SoftphoneSwiftPackage-saas-local", "1.0.180710"..<"1.0.180710")
    ],
    targets: [
        ...
        .binaryTarget(name: "SoftphoneFacade",
                      ...
                      checksum: "a86f01fd4569cb3c187d4a79d0ce533a6be3cd752f9a9bd44aba3642026fcd22"
                     ),
