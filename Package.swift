...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://dist.acrobits.cz/deliveryhero-softphonefacade/SoftphoneFacadeLib.xcframework-1813474.zip",
            checksum: "1e1c0c8f74eebb0a4119498ca4ce27fa50574015dead8e7b982930986a638475"
        )
    ]
)
