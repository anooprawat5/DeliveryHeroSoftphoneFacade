...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://dist.acrobits.cz/deliveryhero-softphonefacade/SoftphoneFacadeLib.xcframework-1814788.zip",
            checksum: "5ce1cdcb51b56f711ea540c4eaa437c86060ef3e5262ed7c73ab3895eb8d6cca"
        )
    ]
)
