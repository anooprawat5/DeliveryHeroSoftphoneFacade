...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://dist.acrobits.cz/deliveryhero-softphonefacade/SoftphoneFacadeLib.xcframework-1814860.zip",
            checksum: "5f17806ee31b51ae4f6d1f138972b027453d6935f49a229b650193d7a4797948"
        )
    ]
)
